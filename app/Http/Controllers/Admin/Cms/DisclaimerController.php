...
class DisclaimerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.cms', ['url' => url('/'), 'datas' => $cmsDetails, 'form_route' => route('admin.Disclaimer.update')]);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.Disclaimer.index')->with('success', 'CMS record updated successfully.');
