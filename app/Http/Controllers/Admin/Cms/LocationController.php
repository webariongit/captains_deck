...
class LocationController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.cms', ['url' => url('/'), 'datas' => $cmsDetails, 'form_route' => route('admin.Location.update')]);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.Location.index')->with('success', 'CMS record updated successfully.');
