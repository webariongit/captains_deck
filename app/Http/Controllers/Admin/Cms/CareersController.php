...
class CareersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.cms', ['url' => url('/'), 'datas' => $cmsDetails, 'form_route' => route('admin.Careers.update')]);
    }
    ...
    public function update(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.Careers.index')->with('success', 'CMS record updated successfully.');
