...
class SliderAndBannersController extends Controller
{
   /**
    ...
    public function index(Request $request)
    {
        try {
            ...
            return view('admin.banner' , ['url' => url('/'), 'datas' => $sliderBannerDetails]);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('admin.banner.index')->with('success', 'banner successfully uploaded.');
    ...
    public function destroy($id)
    {
        try {
            ...
            return redirect()->route('admin.banners.index')->with('success', 'Blog deleted successfully.');
            return response()->json(['message' => 'banner deleted successfully', 'status' => 200], 200);
