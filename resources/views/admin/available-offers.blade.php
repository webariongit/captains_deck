...
<div class="content-page">
            ...
            <div class="row">
                ...
                <div id="edit-blog" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <form method="post" action="{{ route('admin.available-offers.update')}}" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value='{{ ($data->id) }}' class="form-control" name="id" required placeholder="Blog Title">
                                    </div>
                                    <div class="form-group">
                ...
                <div id="reject-blog" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                        <form method="POST" action="{{ route('admin.available-offers.destroy', ['available_offer' => $data->id]) }}">
                            @csrf
                            @method('DELETE')
    ...
    <div id="upload-event" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                <form method="post" action="{{ route('admin.available-offers.store')}}" enctype="multipart/form-data">
                    @csrf
                        <div class="modal-header">
                            <h4 class="modal-title" id="standard-modalLabel">Edit Blog</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        ...
                        <div class="modal-body">
                            <!-- <div class="form-group">
                                <label>id <span class="text-danger">*</span></label>
                                <input type="hidden" value='' class="form-control" name="id" required placeholder="Blog Title">
                            </div> -->
                            <div class="form-group">
                                <label>Title <span class="text-danger">*</span></label>
