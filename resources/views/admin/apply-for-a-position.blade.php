            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">careerss</h4>
                    </div>
                </div>
            </div>     
            <!-- end page title -->
                                ...
                                <tbody>
                                    @foreach($datas as $data)
                                        <tr>
                                            ...
                                            <td>{{ ($data->employee_position_id) }}</td>
                                            <td><a target="_blank" href="{{ asset($data->cv) }} ">open</a></td>
                                        ...
                                        <div id="reject-blog" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <form method="POST" action="{{ route('admin.Careers-req.destroy', ['careerss' => $data->id]) }}">
                                                    @csrf
                                                    @method('DELETE')
